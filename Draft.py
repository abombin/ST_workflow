...
def plot_qc_metrics(
    ...
    -------
    dict
        If group_column is None, returns a dictionary with keys 'figure' and 
        'axes' for the whole dataset.
        If group_column is provided, returns a dictionary mapping each group to 
        its own {'figure', 'axes'} dict for the subsetted AnnData.
    """
